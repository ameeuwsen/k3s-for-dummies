...
kubectl wait --for=condition=Ready pod --all --namespace=metallb-system --timeout=300s
...
kubectl wait --for=condition=Ready pod --all --namespace=ingress-nginx --timeout=300s
